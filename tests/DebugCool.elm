    ...
    describe "Debug cool album issue"
        [ test "Debug cool candidates" <|
            \_ ->
                let
                    candidates =
                        generateSimpleCandidates "cool"

                    _ =
                        Debug.log "cool candidates" candidates
                in
                Expect.pass
        , test "Debug cool alone gets c" <|
            \_ ->
                let
                    ...
                    _ =
                        Debug.log "albumCandidates" albumCandidates

                    sortedAlbumCandidates =
                        smartSortAlbums albumCandidates

                    _ =
                        Debug.log "after smart sorting" sortedAlbumCandidates

                    keybindings =
                        generateAlbumKeybindings albums

                    _ =
                        Debug.log "cool alone keybinding" keybindings
                in
                Expect.pass
        , test "Debug cool with non-conflicting albums" <|
            \_ ->
                let
                    ...
                    _ =
                        Debug.log "cool with non-conflicting keybindings" keybindings
                in
                Expect.pass
        , test "Debug general alone" <|
            \_ ->
                let
                    albums =
                        [ createTestAlbum "1" "general" ]

                    candidates =
                        generateSimpleCandidates "general"

                    _ =
                        Debug.log "general candidates" candidates

                    keybindings =
                        generateAlbumKeybindings albums

                    _ =
                        Debug.log "general alone keybindings" keybindings
                in
                Expect.pass
        ]
