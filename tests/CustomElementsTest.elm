            ...
            [ test "should wait for both URL and API key before loading" <|
                \_ ->
                    ...
                    let
                        hasUrl = True
                        hasValidApiKey = True
                        shouldLoad = hasUrl && hasValidApiKey
                    in
        ...
        , describe "Shared Implementation"
            [ test "image and video elements should use same base logic" <|
                \_ ->
                    ...
                    let
                        sharedAttributes = [ "asset-url", "api-key", "preload-urls" ]
            ...
            , test "should have different preload behaviors" <|
                \_ ->
                    let
                        imagePreloadCount = Nothing -- All images
                        videoPreloadCount = Just 2 -- Only 2 videos
                        imagePreloadDelay = Nothing -- Immediate
                        videoPreloadDelay = Just 1000 -- 1 second delay
                    in
                    Expect.all
